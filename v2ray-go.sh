...
function check_install_status(){
	install_type=$(cat /usr/local/etc/v2ray/install_type.txt)
	if [[ ${install_type} = "" ]]; then
		...
		now_vmess_link="${green_backgroundcolor}$(cat /usr/local/etc/v2ray/vmess_link.txt)${default_fontcolor}"
	fi
	v2ray_config=$(cat /usr/local/etc/v2ray/config.json)
...
#clear
		...
		if [[ ${determine_type} = "1" ]]; then
			wget -O "/usr/local/etc/v2ray/config.json" "https://raw.githubusercontent.com/c0rpse/v2ray-onekey/master/configs/socks5.json"
			if [[ $? -eq 0 ]];then
#clear
...
#clear
			...
			if [[ ${install_socks_username} = "" ]]; then
				...
				sed -i "s/username/${install_socks_username}/g" "/usr/local/etc/v2ray/config.json"
				if [[ $? -eq 0 ]];then
#clear
...
#clear
			...
			if [[ ${install_socks_password} = "" ]]; then
				...
				sed -i "s/passwd/${install_socks_password}/g" "/usr/local/etc/v2ray/config.json"
				if [[ $? -eq 0 ]];then
#clear
...
#clear
			...
			echo "1" > /usr/local/etc/v2ray/install_type.txt
			if [[ $? -eq 0 ]];then
#clear
...
#clear
			...
			wget -O "/usr/local/etc/v2ray/config.json" "https://raw.githubusercontent.com/c0rpse/v2ray-onekey/master/configs/tcp-http.json"
			if [[ $? -eq 0 ]];then
#clear
...
#clear
			install_port="80"
			check_port
			sed -i "s/UserUUID/${UUID}/g" "/usr/local/etc/v2ray/config.json"
			if [[ $? -eq 0 ]];then
#clear
...
#clear
			...
			if [[ ${false_domain} = "" ]]; then
				...
				sed -i "s/cache.m.iqiyi.com/${false_domain}/g" "/usr/local/etc/v2ray/config.json"
				if [[ $? -eq 0 ]];then
#clear
...
#clear
			...
			echo "2" > /usr/local/etc/v2ray/install_type.txt
			if [[ $? -eq 0 ]];then
#clear
				echo -e "${ok_font}写入安装信息成功。"
			else
...
#clear
			...
			wget -O "/usr/local/etc/v2ray/config.json" "https://raw.githubusercontent.com/c0rpse/v2ray-onekey/master/configs/tcp-tls.json"
			if [[ $? -eq 0 ]];then
#clear
				echo -e "${ok_font}V2Ray 配置文件下载成功。"
			else
...
#clear
			...
			check_port
			sed -i "s/443/${install_port}/g" "/usr/local/etc/v2ray/config.json"
			if [[ $? -eq 0 ]];then
#clear
...
#clear
				...
				echo "${install_domain}" > /usr/local/etc/v2ray/full_domain.txt
				if [[ $? -eq 0 ]];then
#clear
...
#clear
			...
			wget -O "/usr/local/etc/v2ray/config.json" "https://raw.githubusercontent.com/c0rpse/v2ray-onekey/master/configs/mkcp-utp.json"
			if [[ $? -eq 0 ]];then
#clear
				echo -e "${ok_font}V2Ray 配置文件下载成功。"
			else
...
#clear
			...
			echo "4" > /usr/local/etc/v2ray/install_type.txt
			if [[ $? -eq 0 ]];then
#clear
				echo -e "${ok_font}写入安装信息成功。"
			else
#clear
			...
			wget -O "/usr/local/etc/v2ray/config.json" "https://raw.githubusercontent.com/c0rpse/v2ray-onekey/master/configs/mkcp-dtls.json"
			if [[ $? -eq 0 ]];then
#clear
				echo -e "${ok_font}V2Ray 配置文件下载成功。"
			else
...
#clear
			...
			echo "5" > /usr/local/etc/v2ray/install_type.txt
			if [[ $? -eq 0 ]];then
#clear
				echo -e "${ok_font}写入安装信息成功。"
			else
#clear
			...
			wget -O "/usr/local/etc/v2ray/config.json" "https://raw.githubusercontent.com/c0rpse/v2ray-onekey/master/configs/mkcp-srtp-dynport.json"
			if [[ $? -eq 0 ]];then
#clear
				echo -e "${ok_font}V2Ray 配置文件下载成功。"
			else
...
#clear
			...
			if [[ ${install_dynport} = "" ]]; then
				...
				sed -i "s/60000-61315/${install_dynport}/g" "/usr/local/etc/v2ray/config.json"
				if [[ $? -eq 0 ]];then
#clear
...
#clear
			...
			echo "6" > /usr/local/etc/v2ray/install_type.txt
			if [[ $? -eq 0 ]];then
#clear
				echo -e "${ok_font}写入安装信息成功。"
			else
...
#clear
			...
			wget -O "/usr/local/etc/v2ray/config.json" "https://raw.githubusercontent.com/c0rpse/v2ray-onekey/master/configs/h2-path.json"
			if [[ $? -eq 0 ]];then
#clear
				echo -e "${ok_font}V2Ray 配置文件下载成功。"
			else
...
#clear
				...
				sed -i "s/PathUUID/${UUID2}/g" "/usr/local/etc/v2ray/config.json"
				if [[ $? -eq 0 ]];then
#clear
					echo -e "${ok_font}V2Ray UUID配置成功。"
				else
#clear
			...
			echo "7" > /usr/local/etc/v2ray/install_type.txt
			if [[ $? -eq 0 ]];then
#clear
				echo -e "${ok_font}写入安装信息成功。"
			else
...
#clear
			...
			wget -O "/usr/local/etc/v2ray/config.json" "https://raw.githubusercontent.com/c0rpse/v2ray-onekey/master/configs/websocket-tls-website-path.json"
...
#clear
				...
				sed -i "s/V2RayListenPort/${v2_listen_port}/g" "/usr/local/etc/v2ray/config.json"
				if [[ $? -eq 0 ]];then
#clear
...
#clear
				...
				mkdir /usr/local/etc/v2ray/pages
				if [[ $? -eq 0 ]];then
#clear
...
#clear
				...
				wget -O "/usr/local/etc/v2ray/pages/v2ray-page.zip" "https://github.com/c0rpse/v2ray-onekey/blob/master/pages/v2ray-page.zip?raw=true"
				if [[ $? -eq 0 ]];then
#clear
...
#clear
				...
				unzip /usr/local/etc/v2ray/pages/v2ray-page.zip
				if [[ $? -eq 0 ]];then
#clear
...
#clear
				...
				rm -rf /usr/local/etc/v2ray/pages/v2ray-page.zip
				if [[ $? -eq 0 ]];then
#clear
...
#clear
				...
				sed -i "s/HTML_NUMBER/${html_number}/g" "/usr/local/etc/v2ray/pages/index.html"
				if [[ $? -eq 0 ]];then
#clear
...
#clear
				...
				sed -i "s/V2rayAddress/${install_domain}/g" "/usr/local/etc/v2ray/pages/index.html"
				if [[ $? -eq 0 ]];then
#clear
...
#clear
			...
			echo "8" > /usr/local/etc/v2ray/install_type.txt
			if [[ $? -eq 0 ]];then
#clear
				echo -e "${ok_font}写入安装信息成功。"
			else
...
#clear
	...
	install_type=$(cat /usr/local/etc/v2ray/install_type.txt)
	if [ "${install_type}" -lt "8" ]; then
		full_domain=$(cat /usr/local/etc/v2ray/full_domain.txt)
...
#clear
	...
	check_port
	sed -i "s/8080/${install_port}/g" "/usr/local/etc/v2ray/config.json"
	if [[ $? -eq 0 ]];then
#clear
		echo -e "${ok_font}V2Ray端口配置成功。"
	else
...
#clear
		...
		open_port
		echo "${install_port}" > /usr/local/etc/v2ray/install_port.txt
	else
#clear
...
\"tls\": \"tls\"
	...
	echo -e "${vmesslink}" > /usr/local/etc/v2ray/vmess_link.txt
}
